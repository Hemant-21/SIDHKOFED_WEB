...
export const metadata: Metadata = buildMetadata({
  title: 'Workshops & Awareness Programmes',
  description: 'Community workshops and awareness programmes conducted by SIDHKOFED across Jharkhand.',
  path: '/activities/workshops-awareness',
});

type SP = Record<string, string | string[] | undefined>;

export default async function WorkshopsPage({ searchParams }: { searchParams: SP }) {
  ...
  const [list, districts] = await Promise.all([
    getListSafe<EventSummary>(PUBLIC_ENDPOINTS.events, {
      query: {
        ...
        event_type: ACTIVITY_TYPES.workshops,
  ...
  return (
    <ListingLayout
      ...
      subtitleKey="page.activities.workshops.subtitle"
      crumb="Workshops & Awareness"
